...
import { MapPin, Clock, Phone, Navigation, CalendarDays, User, LocateFixed } from "lucide-react";
...
export default function VenuePage() {
  // Later you’ll fetch this by ID from your DB
  const venue = {
    name: "Club Eclipse",
  ...
  return (
    <div className="min-h-screen bg-[#050010] text-white flex flex-col">
      ...
      {/* Content */}
      <div className="flex-1 pb-20 px-5 pt-10">
        {/* Header */}
      ...
      {/* Bottom nav */}
      <nav className="fixed bottom-0 left-0 right-0 border-t border-white/10 bg-[#050010]/95 backdrop-blur-md">
